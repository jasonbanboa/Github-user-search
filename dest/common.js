...
const util = {
    ...
    resetForm({ name, login }) {
        $form.reset();
        $input.placeholder = name !== null && name !== void 0 ? name : login;
    },
    handleError(query) {
...
const handler = {
    formSubmit(e) {
        return __awaiter(this, void 0, void 0, function* () {
            e.preventDefault();
            const userData = yield fetchUserData($input.value);
            if (!userData.login) {
...
function renderCard(userData) {
    ...
    const date = util.formatDate(created_at);
    $main.innerHTML = `
...
window.onload = () => {
    main();
    $form === null || $form === void 0 ? void 0 : $form.addEventListener('submit', handler.formSubmit);
    $theme === null || $theme === void 0 ? void 0 : $theme.addEventListener('click', handler.changeTheme);
};
